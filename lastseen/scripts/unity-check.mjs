...
function scratchProject() {
  ...
  const keep = new Set(["com.unity.nuget.newtonsoft-json", "com.unity.test-framework", "com.unity.inputsystem", "com.unity.xr.arfoundation", "com.unity.ugui"]);
  ...
  if (!dependencies["com.unity.ugui"]) dependencies["com.unity.ugui"] = "2.0.0"; // TextMeshPro (DistanceReadout); the real project gets it transitively
